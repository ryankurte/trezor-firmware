...
void dalek_curved25519_scalarmult_basepoint(ed25519_public_key res, const ed25519_secret_key sk);
...
void dalek_curve25519_scalarmult(curved25519_key mypublic, const curved25519_key secret, const curved25519_key basepoint);

/// COSI combine public keys (ed25519 point addition)
int dalek_ed25519_cosi_combine_publickeys(ed25519_public_key res, const ed25519_public_key *pks, size_t n);

// Not yet implemented COSI methods
#if 0

void dalek_ed25519_cosi_combine_signatures(ed25519_signature res, const ed25519_public_key R, const ed25519_cosi_signature *sigs, size_t n);

void dalek_ed25519_cosi_sign(const unsigned char *m, size_t mlen, const ed25519_secret_key sk, const ed25519_secret_key nonce, const ed25519_public_key R, const ed25519_public_key pk, ed25519_signature sig);

#endif

// Ed25519 with Keccak512

void dalek_ed25519_publickey_keccak(const ed25519_secret_key sk, ed25519_public_key pk);

int dalek_ed25519_sign_open_keccak(const unsigned char *m, size_t mlen, const ed25519_public_key pk, const ed25519_signature RS);

void dalek_ed25519_sign_keccak(const unsigned char *m, size_t mlen, const ed25519_secret_key sk, const ed25519_public_key pk, ed25519_signature RS);

int dalek_ed25519_scalarmult_keccak(ed25519_public_key res, const ed25519_secret_key sk, const ed25519_public_key pk);

void dalek_curved25519_scalarmult_basepoint_keccak(ed25519_public_key res, const ed25519_secret_key sk);
...
int dalek_ed25519_scalarmult_sha3(ed25519_public_key res, const ed25519_secret_key sk, const ed25519_public_key pk);

void dalek_curved25519_scalarmult_basepoint_sha3(ed25519_public_key res, const ed25519_secret_key sk);
